...
export default restart => {
    ...
    // engine.gravity.x = 0.1; Подумай о ветре
    
    const ammo = Ammo(world, { x: 250, y:  100 }, { radius: 10 });
    ...
    return {
        ...
        PortalIn: Portal(world, { x: 200, y:  100 }, 0),

        PortalOut: Portal(world, { x: 600, y:  100 }, 3.5),

        // Shield: Shield(world, { x: 538, y: 150 }, { radius: 130 }),
